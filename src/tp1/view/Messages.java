...
//Commands
	...
	public static final String INVALID_COMMAND_PARAMS = "Invalid command parameters";
	...
	public static final String COMMAND_RESET_HELP = "[numLevel]: reset the game to initial configuration if not numLevel else load the numLevel map";		
